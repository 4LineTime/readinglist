...
@my_decorator
# hopefully tthe wrapper decoratpr will do thiswill allow the show books funcgtion to print a line above and below its stateme
def show_books(books):
    ...
    [print(book) for book in books]if books else print('No books to display')
    #  above more pythonic way of writing function
